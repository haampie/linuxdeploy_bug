...
# Compile the project
g++ -O2 -shared -o deps/libdep1.so -Wl,--enable-new-dtags -Wl,-rpath="\$ORIGIN" deps/dep1.cc
g++ -O2 -shared -o deps/libdep2.so -Wl,--enable-new-dtags -Wl,-rpath="\$ORIGIN" deps/dep2.cc -Ldeps -ldep1
g++ -O2 -o Example.AppDir/usr/bin/example -Wl,--enable-new-dtags -Wl,-rpath="$(realpath deps)" src/example.cc -Ldeps -ldep2
